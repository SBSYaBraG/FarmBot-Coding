...
void loop() {
  ...
  Serial.println("Accelerating and Decelerating CW...");
  rotateStepper(Steps_Rev, true);
  delay(1000);

  Serial.println("Accelerating and Decelerating CCW...");
  rotateStepper(Steps_Rev, false);
  delay(1000);
  */
}
