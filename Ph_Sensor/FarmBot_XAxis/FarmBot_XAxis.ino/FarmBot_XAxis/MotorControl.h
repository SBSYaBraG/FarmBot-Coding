 ...
 * Handles stepper motor movement, acceleration, and basic motor functions.
 */
...
/**
 * Process a relative movement (for backward compatibility)
 * 
...
/**
 * Process an absolute movement (for backward compatibility)
 * 
