 ...
 * Controls the stepper motor with acceleration and deceleration profiles.
 */
...
/**
 * Process a relative movement command (compatibility function)
 * 
...
/**
 * Process an absolute positioning command (compatibility stub)
 * 
